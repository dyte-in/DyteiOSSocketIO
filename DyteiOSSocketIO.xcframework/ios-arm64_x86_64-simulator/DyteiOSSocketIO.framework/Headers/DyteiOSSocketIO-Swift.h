...
#ifndef DYTEIOSSOCKETIO_SWIFT_H
#define DYTEIOSSOCKETIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DyteiOSSocketIO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC15DyteiOSSocketIO13OnAckCallback")
...
SWIFT_CLASS("_TtC15DyteiOSSocketIO16SocketAckEmitter")
...
SWIFT_CLASS("_TtC15DyteiOSSocketIO14SocketAnyEvent")
...
SWIFT_CLASS("_TtC15DyteiOSSocketIO12SocketEngine")
...
SWIFT_PROTOCOL("_TtP15DyteiOSSocketIO18SocketEngineClient_")
...
typedef SWIFT_ENUM(NSInteger, SocketEvent, open) {
  SocketEventConnect = 1,
  SocketEventConnecting = 2,
  SocketEventDisconnect = 3,
  SocketEventError = 4,
  SocketEventMessage = 5,
  SocketEventReconnect = 6,
  SocketEventReconnectAttempt = 7,
  SocketEventPing = 8,
  SocketEventPong = 9,
};
...
SWIFT_CLASS("_TtC15DyteiOSSocketIO14SocketIOClient")
...
enum SocketIoTransport : NSInteger;

SWIFT_CLASS("_TtC15DyteiOSSocketIO8SocketIo")
@interface SocketIo : NSObject
- (nonnull instancetype)initWithEndpoint:(NSString * _Nonnull)endpoint queryParams:(NSDictionary<NSString *, id> * _Nullable)queryParams transport:(enum SocketIoTransport)transport OBJC_DESIGNATED_INITIALIZER;
- (void)connect;
- (void)disconnect;
- (void)ackCallWithData:(NSArray * _Nonnull)data ack:(NSString * _Nonnull)ack;
- (BOOL)isConnected SWIFT_WARN_UNUSED_RESULT;
- (void)onCustomWithEvent:(NSString * _Nonnull)event action:(void (^ _Nonnull)(NSArray * _Nonnull))action;
- (void)onSocketEvent:(enum SocketEvent)socketEvent action:(void (^ _Nonnull)(NSArray * _Nonnull, SocketAckEmitter * _Nonnull))action;
- (void)emitWithEvent:(NSString * _Nonnull)event data:(NSArray * _Nonnull)data;
- (void)emitAckWithEvent:(NSString * _Nonnull)event data:(NSString * _Nonnull)data callback:(void (^ _Nonnull)(NSArray * _Nonnull))callback;
- (void)emitWithEvent:(NSString * _Nonnull)event string:(NSString * _Nonnull)string;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, SocketIoTransport, open) {
  SocketIoTransportWebsocket = 0,
  SocketIoTransportPolling = 1,
  SocketIoTransportUndefined = 2,
};
...
SWIFT_CLASS("_TtC15DyteiOSSocketIO13SocketManager")
...
///
/// \endcode
SWIFT_CLASS("_TtC15DyteiOSSocketIO16SocketRawAckView")
...
///
/// \endcode
SWIFT_CLASS("_TtC15DyteiOSSocketIO13SocketRawView")
